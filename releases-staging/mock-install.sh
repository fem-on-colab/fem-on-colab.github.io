...
if [[ ! -f $MOCK_INSTALLED ]]; then
    ...
    MOCK_ARCHIVE_PATH=${MOCK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/staging-mock-20260904-105253-fa1516d/mock-install.tar.gz"}
