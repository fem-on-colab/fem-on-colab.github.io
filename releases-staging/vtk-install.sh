...
if [[ ! -f $VTK_INSTALLED ]]; then
    ...
    H5PY_INSTALL_SCRIPT_PATH=${H5PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/add63477/releases-staging/h5py-install.sh"}
    ...
    VTK_ARCHIVE_PATH=${VTK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/staging-vtk-20260904-083347-0be0e98/vtk-install.tar.gz"}
