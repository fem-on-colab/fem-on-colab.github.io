...
if [[ ! -f $H5PY_INSTALLED ]]; then
    ...
    H5PY_ARCHIVE_PATH=${H5PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/staging-h5py-20260904-082048-0be0e98/h5py-install.tar.gz"}
