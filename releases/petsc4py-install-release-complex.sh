...
if [[ ! -f $PETSC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_ARCHIVE_PATH=${PETSC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/petsc4py-20250921-135215-04afd31-release-complex/petsc4py-install.tar.gz"}
