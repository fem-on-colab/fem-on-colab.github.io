...
#        https://fem-on-colab.github.io/releases/firedrake-install-complex.sh      #
#                  to either of the following URLs                                 #
#        1) if interested in the latest firedrake release, please use              #
# https://fem-on-colab.github.io/releases/firedrake-install-release-complex.sh     #
#                 (note the additional "-release-" in the URL).                    #
#        2) if interested in firedrake development version, please use             #
# https://fem-on-colab.github.io/releases/firedrake-install-development-complex.sh #
