...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    # Install vtk
    VTK_INSTALL_SCRIPT_PATH=${VTK_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/1160b90/releases/vtk-install.sh"}
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/firedrake-20240107-185742-b860330-complex/firedrake-install.tar.gz"}
