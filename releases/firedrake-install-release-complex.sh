...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/firedrake-20260704-014706-1da6c86-release-complex/firedrake-install.tar.gz"}
