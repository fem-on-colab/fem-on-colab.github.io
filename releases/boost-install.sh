...
if [[ ! -f $BOOST_INSTALLED ]]; then
    ...
    BOOST_ARCHIVE_PATH=${BOOST_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/boost-20221031-112009-efa918f/boost-install.tar-eca7d6ada0f38832ff177ff2ecdfddd9.gz"}
