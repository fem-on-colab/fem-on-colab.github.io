...
if [[ ! -f $FENICSX_INSTALLED ]]; then
    ...
    FENICSX_ARCHIVE_PATH=${FENICSX_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/fenicsx-20240720-011522-55607e0-real/fenicsx-install.tar.gz"}
