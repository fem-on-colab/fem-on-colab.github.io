...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    SLEPC4PY_INSTALL_SCRIPT_PATH=${SLEPC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/4d07eec1/releases/slepc4py-install-development-complex.sh"}
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/firedrake-20260419-121926-2c72263-development-complex/firedrake-install.tar.gz"}
