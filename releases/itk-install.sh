...
if [[ ! -f $ITK_INSTALLED ]]; then
    # Install vtk
    VTK_INSTALL_SCRIPT_PATH=${VTK_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/2813cb1/releases/vtk-install.sh"}
    ...
    ITK_ARCHIVE_PATH=${ITK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/itk-20220916-055118-ceb18bd/itk-install.tar.gz"}
