...
if [[ ! -f $ITK_INSTALLED ]]; then
    ...
    ITK_ARCHIVE_PATH=${ITK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/itk-20221001-055414-9d8a3e5/itk-install.tar-4cf7ab5fb1d506b8b5d5febbfd56c35f.gz"}
