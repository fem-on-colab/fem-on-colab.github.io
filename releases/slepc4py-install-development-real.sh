...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_INSTALL_SCRIPT_PATH=${PETSC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/9102fff2/releases/petsc4py-install-development-real.sh"}
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/slepc4py-20250501-084225-7e306e5-development-real/slepc4py-install.tar.gz"}
