...
if [[ ! -f $GCC_INSTALLED ]]; then
    ...
    GCC_ARCHIVE_PATH=${GCC_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/gcc-20221030-144412-67a7365/gcc-install.tar.gz"}
    ...
    if [[ $GCC_ARCHIVE_PATH != skip ]]; then
        ...
        LEGACY_GCC_VERSION=$(/usr/bin/gcc -dumpversion)
