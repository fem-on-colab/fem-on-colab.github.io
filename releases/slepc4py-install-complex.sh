...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_INSTALL_SCRIPT_PATH=${PETSC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/48d3048/releases/petsc4py-install-complex.sh"}
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/slepc4py-20221001-042316-0d13545-complex/slepc4py-install.tar.gz"}
