...
if [[ ! -f $MPI4PY_INSTALLED ]]; then
    ...
    MPI4PY_ARCHIVE_PATH=${MPI4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/mpi4py-20231101-023118-4d10d21/mpi4py-install.tar.gz"}
