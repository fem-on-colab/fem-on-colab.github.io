...
if [[ ! -f $MPI4PY_INSTALLED ]]; then
    ...
    MPI4PY_ARCHIVE_PATH=${MPI4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/mpi4py-20250118-130519-5ba52bb/mpi4py-install.tar.gz"}
