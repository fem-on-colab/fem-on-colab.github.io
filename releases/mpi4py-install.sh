...
if [[ ! -f $MPI4PY_INSTALLED ]]; then
    ...
    MPI4PY_ARCHIVE_PATH=${MPI4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/mpi4py-20220601-014546-5beb12e/mpi4py-install.tar.gz"}
