...
if [[ ! -f $PETSC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_ARCHIVE_PATH=${PETSC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/petsc4py-20250901-030729-532dd55-development-complex/petsc4py-install.tar.gz"}
