...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_INSTALL_SCRIPT_PATH=${PETSC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/5ddea957/releases/petsc4py-install-release-complex.sh"}
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/slepc4py-20260301-074204-4152e9b-release-complex/slepc4py-install.tar.gz"}
