...
if [[ ! -f $GMSH_INSTALLED ]]; then
    ...
    H5PY_INSTALL_SCRIPT_PATH=${H5PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/1587b98/releases/h5py-install.sh"}
    ...
    GMSH_ARCHIVE_PATH=${GMSH_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/gmsh-20230428-052000-14a46df/gmsh-install.tar.gz"}
