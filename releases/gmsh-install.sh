...
if [[ ! -f $GMSH_INSTALLED ]]; then
    ...
    H5PY_INSTALL_SCRIPT_PATH=${H5PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/f025caf/releases/h5py-install.sh"}
    ...
    GMSH_ARCHIVE_PATH=${GMSH_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/gmsh-20221103-085535-2258c94/gmsh-install.tar.gz"}
