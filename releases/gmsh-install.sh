...
if [[ ! -f $GMSH_INSTALLED ]]; then
    ...
    H5PY_INSTALL_SCRIPT_PATH=${H5PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/e1addef/releases/h5py-install.sh"}
    ...
    GMSH_ARCHIVE_PATH=${GMSH_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/gmsh-20230719-181125-916a45c/gmsh-install.tar.gz"}
