...
if [[ ! -f $PYBIND11_INSTALLED ]]; then
    ...
    PYBIND11_ARCHIVE_PATH=${PYBIND11_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/pybind11-20240801-022301-f2dac71/pybind11-install.tar.gz"}
