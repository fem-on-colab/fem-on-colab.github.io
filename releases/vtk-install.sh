...
if [[ ! -f $VTK_INSTALLED ]]; then
    ...
    VTK_ARCHIVE_PATH=${VTK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/vtk-20221001-023952-0d13545/vtk-install.tar-893998b5dfdcfefbeacc07e4e9ca7ef8.gz"}
