...
if [[ ! -f $VTK_INSTALLED ]]; then
    ...
    VTK_ARCHIVE_PATH=${VTK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/vtk-20221027-115528-d75a030/vtk-install.tar-203bc2e685d255fdcd34acc54d477c89.gz"}
