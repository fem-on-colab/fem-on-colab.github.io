...
if [[ ! -f $VTK_INSTALLED ]]; then
    ...
    VTK_ARCHIVE_PATH=${VTK_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/vtk-20221027-055323-58b3fe2/vtk-install.tar-5de3e79cb2b38a459734a9b8b54c1d9a.gz"}
