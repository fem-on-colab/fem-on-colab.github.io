...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/slepc4py-20230601-040639-522cb4f-real/slepc4py-install.tar.gz"}
