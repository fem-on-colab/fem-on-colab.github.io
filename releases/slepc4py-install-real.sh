...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/slepc4py-20230209-122300-59f8587-real/slepc4py-install.tar.gz"}
