...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    SLEPC4PY_INSTALL_SCRIPT_PATH=${SLEPC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/07b0819f/releases/slepc4py-install-development-real.sh"}
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/firedrake-20250701-080931-9ceb697-development-real/firedrake-install.tar.gz"}
