...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/firedrake-20260620-053753-45ef218-development-real/firedrake-install.tar.gz"}
