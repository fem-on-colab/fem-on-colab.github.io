...
if [[ ! -f $NGSOLVE_INSTALLED ]]; then
    ...
    NGSOLVE_ARCHIVE_PATH=${NGSOLVE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/ngsolve-20250712-021958-ea9f24f-development-real/ngsolve-install.tar.gz"}
