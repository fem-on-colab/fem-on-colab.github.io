...
if [[ ! -f $NGSOLVE_INSTALLED ]]; then
    ...
    NGSOLVE_ARCHIVE_PATH=${NGSOLVE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/ngsolve-20250928-160143-eef96b3-release-real/ngsolve-install.tar.gz"}
