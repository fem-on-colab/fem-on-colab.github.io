...
if [[ ! -f $H5PY_INSTALLED ]]; then
    # Install mpi4py
    MPI4PY_INSTALL_SCRIPT_PATH=${MPI4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/cb8e218/releases/mpi4py-install.sh"}
    ...
    H5PY_ARCHIVE_PATH=${H5PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/h5py-20220601-020443-5beb12e/h5py-install.tar-0ad725b92e2aa10a5d26d035f70886ce.gz"}
