...
if [[ ! -f $NGSOLVE_INSTALLED ]]; then
    ...
    NGSOLVE_ARCHIVE_PATH=${NGSOLVE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/ngsolve-20260214-173747-28bcff1-release-complex/ngsolve-install.tar.gz"}
