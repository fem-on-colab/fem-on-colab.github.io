...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    PETSC4PY_INSTALL_SCRIPT_PATH=${PETSC4PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/f69f8b2f/releases/petsc4py-install-release-real.sh"}
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/slepc4py-20250921-183517-1f46c88-release-real/slepc4py-install.tar.gz"}
