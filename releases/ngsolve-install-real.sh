...
if [[ ! -f $NGSOLVE_INSTALLED ]]; then
    ...
    NGSOLVE_ARCHIVE_PATH=${NGSOLVE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/ngsolve-20241130-071649-e11a96a-real/ngsolve-install.tar.gz"}
