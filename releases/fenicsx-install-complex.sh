...
if [[ ! -f $FENICSX_INSTALLED ]]; then
    ...
    ITK_INSTALL_SCRIPT_PATH=${ITK_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/c3ff165/releases/itk-install.sh"}
    ...
    FENICSX_ARCHIVE_PATH=${FENICSX_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/fenicsx-20221030-200811-6c17757-complex/fenicsx-install.tar.gz"}
