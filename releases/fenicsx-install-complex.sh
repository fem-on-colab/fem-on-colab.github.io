...
#        https://fem-on-colab.github.io/releases/fenicsx-install-complex.sh        #
#                  to either of the following URLs                                 #
#        1) if interested in the latest FEniCSx release, please use                #
# https://fem-on-colab.github.io/releases/fenicsx-install-release-complex.sh       #
#                 (note the additional "-release-" in the URL).                    #
#        2) if interested in FEniCSx development version, please use               #
# https://fem-on-colab.github.io/releases/fenicsx-install-development-complex.sh   #
