...
if [[ ! -f $FENICSX_INSTALLED ]]; then
    ...
    ITK_INSTALL_SCRIPT_PATH=${ITK_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-colab/fem-on-colab.github.io/raw/a90b3ba/releases/itk-install.sh"}
    ...
    FENICSX_ARCHIVE_PATH=${FENICSX_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/fenicsx-20220901-125239-66a9f58-complex/fenicsx-install.tar-507e15bc64a9b27ea9f69b6d3e81e468.gz"}
