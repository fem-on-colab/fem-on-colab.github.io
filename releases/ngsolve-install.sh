...
if [[ ! -f $NGSOLVE_INSTALLED ]]; then
    ...
    NGSOLVE_ARCHIVE_PATH=${NGSOLVE_ARCHIVE_PATH:-"https://github.com/fem-on-colab/fem-on-colab/releases/download/ngsolve-20230719-181149-916a45c/ngsolve-install.tar.gz"}
